...
func (b *tuiDaemonBackend) StartProcessing(ctx context.Context, request api.StartProcessingRequest) (api.ProcessingJob, error) {
	return withTUIClient(ctx, b, func(c *client.Client) (api.ProcessingJob, error) { return c.StartProcessing(ctx, request) })
}
