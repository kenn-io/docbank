...
const renderLintSourcePath = "C:\\Users\\Rod\\.codex\\plugins\\cache\\personal\\pr\\0.0.15\\shared\\lint\\render-lint.js";
...
`,{mode:0o600});
    ...
    const renderLintFile = await readFile(renderLintSourcePath,"utf8");
    const renderLintSource = renderLintFile.slice(renderLintFile.indexOf("function collectRenderViolations"));
    const lintEnd = renderLintSource.indexOf("\nfunction renderLintSnippet");
    const collectRenderViolations = renderLintSource.slice(0,lintEnd);
