...
func main() {
	...
	descriptor, err := document.NewEmbeddingDescriptor(document.EmbeddingDescriptor{
		...
		ScalarEncoding:        openaicompat.ScalarEncodingFloat32,
		DocumentFormatter:     openaicompat.DocumentFormatterV1,
		QueryFormatter:        openaicompat.QueryFormatterV1,
	...
	policyFingerprint, err := openaicompat.PolicyFingerprint(profile)
	if err != nil {
		panic(err)
	}
