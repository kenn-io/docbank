...
export interface JobSemantics {
  cancel_route_id?: string;
  durable: boolean;
  status_route_id?: string;
}
...
/**
 * Return claims for this record only. Omit to return package-level defaults only.
 */
row_id?: string;
...
export const getReadAgentCapabilitiesUrl = () => {




  return `/api/v1/agent/capabilities`
}

/**
 * @summary Read currently available agent operations
 */
export const readAgentCapabilities = async ( options?: Parameters<typeof sessionJSON>[1]): Promise<AgentCapabilities> => {

  return sessionJSON<AgentCapabilities>(getReadAgentCapabilitiesUrl(),
  {
    ...options,
    method: 'GET'
