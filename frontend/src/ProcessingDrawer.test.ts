    ...
    vi.spyOn(globalThis, "fetch").mockImplementation(async (input, init) => {
      ...
      if (path === "/api/v1/processing/plans") {
        ...
        return Response.json({
          ...
          flow: [{ capability: "rendition", provider_id: "private-provider", trust_boundary: "local_process", input_classes: ["original_file"], runtime_disclosure: {
            immediate_processor: "private-provider", ultimate_processor: "private-provider", endpoint: "in-process",
            deployment: fingerprint, metadata_classes: [], retained_artifact_roles: ["sanitized_markdown"],
          } }],
    ...
    vi.spyOn(globalThis, "fetch").mockImplementation(async (input) => {
      ...
      if (path === "/api/v1/processing/plans") {
        return Response.json({
          ...
          flow: [
            { capability: "rendition", provider_id: "docling-local", trust_boundary: "operator_network", input_classes: ["original_file"], disclose_filename: true, filename: "report.pdf", runtime_disclosure: {
