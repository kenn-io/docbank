...
// provider that produced it. The zero value means that no transcript was
// supplied. A nonzero Provider and nonempty Text identify a usable transcript;
// either field missing makes the value malformed. The attribution records a
// caller claim; this type does not verify provider identity or transcript
// authenticity.
...
// BuildTranscriptSourceEvidenceV1 builds source evidence and the retained
// transcript artifact without normalizing the evidence for rendition output.
