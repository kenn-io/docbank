...
func (client *Client) Embed(ctx context.Context, inputs []document.EmbeddingInput, authorization document.EmbeddingAuthorization) (document.EmbeddingResult, error) {
	...
	frozenInputs, err := freezeInputMetadata(inputs, authorization)
	if err != nil {
...
func freezeInputMetadata(inputs []document.EmbeddingInput, authorization document.EmbeddingAuthorization) ([]document.EmbeddingInput, error) {
