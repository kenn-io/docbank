...
var storeErrCodes = []struct {
	...
	{store.ErrProcessingConsentRequired, http.StatusForbidden, "processing_consent_required"},
	{store.ErrProcessingConsentExpired, http.StatusForbidden, "processing_consent_expired"},
	{store.ErrProcessingConsentRevoked, http.StatusForbidden, "processing_consent_revoked"},
