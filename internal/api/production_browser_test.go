...
func TestProductionSetBrowserAllowlist(t *testing.T) {
	...
	for _, route := range []struct{ method, path string }{
		{http.MethodPost, "/api/v1/productions/jobs/88888888-8888-4888-8888-888888888887/packages"},
		...
		{http.MethodGet, base + "/revisions/1/members/88888888-8888-4888-8888-888888888887/pdf"},
		...
		{http.MethodPost, base + "/revisions/1/previews"},
	...
	for _, route := range []struct{ method, path string }{
		{http.MethodPost, "/api/v1/productions/jobs/88888888-8888-4888-8888-888888888887/packages?unexpected=1"},
		...
		{http.MethodGet, base + "/revisions/1/members/88888888-8888-4888-8888-888888888887/pdf?unexpected=1"},
		{http.MethodGet, base + "/revisions/1/members/bad/pdf"},
		...
		{http.MethodPost, base + "/revisions/1/previews?unexpected=1"},
		{http.MethodGet, base + "/revisions/1/previews"},
