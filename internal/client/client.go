...
var codeToTypedErr = map[string]error{
	...
	"processing_consent_required":  store.ErrProcessingConsentRequired,
	"processing_consent_expired":   store.ErrProcessingConsentExpired,
	"processing_consent_revoked":   store.ErrProcessingConsentRevoked,
