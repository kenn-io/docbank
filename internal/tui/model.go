...
func (m Model) Update(message tea.Msg) (tea.Model, tea.Cmd) {
	...
	case processingStartedMsg:
		...
		return m, m.loadProcessingStatus(msg.job.ID, msg.requestID)
...
func (m Model) updateProcessingKeys(msg tea.KeyPressMsg) (tea.Model, tea.Cmd) {
	...
	case "b":
		...
		return m, tea.Batch(m.startSpinner(), m.startProcessing(*m.processingPlan, m.processingRequestID, false))
	case "R":
		if m.processingPlan == nil {
			return m, nil
		}
...
func (m Model) updateProcessingConfirmationKeys(msg tea.KeyPressMsg) (tea.Model, tea.Cmd) {
	...
	case keyEnter:
		...
		m.processingStarting = true
		m.processingErr = nil
		return m, tea.Batch(m.startSpinner(), m.startProcessing(plan, m.processingRequestID, true))
	}
	return m, nil
}
