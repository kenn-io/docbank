...
func (m Model) helpLines() []string {
	if m.packagesOpen {
		return []string{
			...
			"",
			"↑/k, ↓/j       Move through packages, members, or labels",
			"PgUp/PgDn      Scroll one visible page",
			"Home/End       Jump to first or last row on this page",
			"Enter          Open members from the package list",
			...
			"q              Quit",
			"",
			"Counts describe this page; + means another page is available.",
			"Loading a page replaces the current rows.",
