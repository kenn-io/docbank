	...
	if err := tx.QueryRowContext(ctx, `
		SELECT
		  ...
		  (SELECT COUNT(*) FROM blobs) + (SELECT COUNT(*) FROM content_versions)
		    ...
		    + (SELECT COUNT(*) FROM production_text_maps)
		    + (SELECT COUNT(*) FROM production_text_map_frames)
		    + (SELECT COUNT(*) FROM production_catalog_entries)
		    + (SELECT COUNT(*) FROM production_sets)
		    + (SELECT COUNT(*) FROM production_revisions)
		    + (SELECT COUNT(*) FROM production_members)
		    + (SELECT COUNT(*) FROM production_member_policy_facts)
		    + (SELECT COUNT(*) FROM production_revision_email_publications)
		    + (SELECT COUNT(*) FROM production_revision_gate_authority)
		    + (SELECT COUNT(*) FROM production_decisions)
		    + (SELECT COUNT(*) FROM production_operations)
		    + (SELECT COUNT(*) FROM production_audit_evidence)
		    + (SELECT COUNT(*) FROM production_finalized_revisions)
