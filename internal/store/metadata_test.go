...
func TestBackupExcludesOrdinaryUnreachableBlobsAndUncommittedProviderStaging(t *testing.T) {
	s := newTestStore(t)
	...
	assert.NotContains(t, exported.String(), ordinary,
		"ordinary unreachable content has no retained logical backup authority")
