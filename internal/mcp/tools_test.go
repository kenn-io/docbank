...
func TestSessionFileCatalogOnlyAdvertisesWorkingReadTools(t *testing.T) {
	...
	listed := decodeResult(t, exchangeRaw(t, server, requestFor("tools/list", map[string]any{})))
	assert.Equal(t, []string{"get_agent_capabilities", "get_format_coverage", "list_processing_profiles", "list_tags"},
