...
var readToolDefinitions = []toolDefinition{
	...
	{name: "suggest_connections", title: "Suggest connections", description: "Find exact passage candidates from stored evidence inside an explicit source fence.", schemas: suggestConnectionsSchemas},
