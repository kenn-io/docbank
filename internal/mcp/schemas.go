...
func packageImportOutputSchema() schema {
	...
	}), cacheRequired("operation_id", "job_id", packageIDField, "preflight_id", stateField, "committed", "total", "gap_count", "created_at", "updated_at")...)
}
...
func getProcessingStatusSchemas() (schema, schema) {
	...
	output := rootObjectSchema(withPrivateCache(schema{
		"job_id": sha256Schema(), "content_version_id": uuidSchema(), stateField: stringSchema(64), "phase": stringSchema(64),
		"failure_code": stringSchema(64), "embedding_job_ids": arraySchema(sha256Schema(), 64),
		"completed_bindings": integerSchema(0, 64),
	}), cacheRequired("job_id", stateField, "phase", "embedding_job_ids", "completed_bindings")...)
	return input, output
}
...
func startProcessingSchemas() (schema, schema) {
	...
	}), cacheRequired("job_id", "embedding_job_ids", "profile_fingerprint", "content_version_id", stateField)...)
	return input, output
}
