...
identity, publishes repaired loose authority, and retires any packed mapping
without changing nodes or content versions. The immutable source pack is
reclaimed only by a later repack pass.
